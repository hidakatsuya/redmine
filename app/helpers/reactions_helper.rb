...
module ReactionsHelper
  ...
  def reaction_button_reacted(object, reaction, count, tooltip)
    reaction_button_wrapper object do
      link_to(
        ...
        class: ['icon', 'reaction-button', 'reacted', { 'has-reaction': count.nonzero? }],
        title: tooltip
      )
    end
  end
  ...
  def reaction_button_not_reacted(object, count, tooltip)
    reaction_button_wrapper object do
      link_to(
        ...
        class: ['icon', 'reaction-button', { 'has-reaction': count.nonzero? }],
        title: tooltip
      )
    end
  end
  ...
  def reaction_button_readonly(object, count, tooltip)
    reaction_button_wrapper object do
      tag.span(class: ['icon', 'reaction-button', 'readonly', { 'has-reaction': count.nonzero? }], title: tooltip) do
        sprite_icon('thumb-up', count.nonzero?)
      end
    end
  end
