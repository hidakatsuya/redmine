...
add('G17-columns', 'bulk', zoom=2, columns=True)
add('G17-collapse', 'bulk', zoom=2, actions=['collapse-first-parent'])
add('G18-ja', user='visual-ja', title='Japanese locale')
add('G18-ar', user='visual-ar', title='Arabic locale (RTL layout)')
